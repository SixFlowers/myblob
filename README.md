...
[DEBUG] HTTPProvider: Created for httpbin.org:80
请求已添加到事务
状态: 0
成功: 否
[DEBUG] ConnectionManager::closeAll: closing 0 connections
```
...
```
Init → Sending → Receiving → Finished
  ↓        ↓         ↓
...
| 版本 6 | TLS/HTTPS 版：TLSContext、TLSConnection | 🔲 计划 |
